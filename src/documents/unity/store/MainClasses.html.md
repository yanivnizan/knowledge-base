...
To see more usage examples of the functions of these classes see [Economy Model](/unity/store/EconomyModel).
...
<div class="info-box">This is the only class you need to initialize in order to use the SOOMLA SDK. More about this in [Getting Started](/unity/store/GettingStarted).</div>
...
Buys the item that has the given itemId according to its purchase type - either with real money ($$$) or with other virtual items. Read more about PurchaseTypes in [Economy Model](/unity/store/EconomyModel#purchase-types).
