...
This event will be thrown when the user rates your app.
...
This event will be thrown when a social action has finished.
...
This event will be thrown when fetching the contacts from the social provider has finished.
...
This event will be thrown when fetching the feed from the social provider has finished.
