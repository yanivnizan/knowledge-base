...
<div class="info-box">**NOTE:** If you haven't already, we suggest reading about the [LevelUp Model](/docs/platforms/cocos2dx/Levelup_Model) and [LevelUp Event Handling](/docs/platforms/cocos2dx/Levelup_Events).</div>
